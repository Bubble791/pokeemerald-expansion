...
#define LAST_STRINGID STRINGID_TERRAINREMOVED
#define STRINGID_PLAYERLOSTTOENEMYTRAINER   LAST_STRINGID + 1
#define STRINGID_PLAYERPAIDPRIZEMONEY       LAST_STRINGID + 2

#define BATTLESTRINGS_COUNT     STRINGID_PLAYERPAIDPRIZEMONEY + 1
